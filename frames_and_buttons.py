...
class myGUI:
    def __init__(self):
        ...
        self.mybutton = t.Button(self.main_window,text="Click Me!",command=self.do_something)
        self.quitbutton = t.Button(self.main_window,text="QUIT",command=self.main_window.destroy)
